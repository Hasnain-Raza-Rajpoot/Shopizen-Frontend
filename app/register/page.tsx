        ...
        <div className="max-w-md mx-auto">
          <Card>
            <CardHeader className="text-center">
              ...
              <CardDescription>Join thousands of happy customers shopping with us</CardDescription>
            </CardHeader>
          ...
          <div className="mt-8 text-center text-sm text-muted-foreground">
            ...
            <p className="mt-2">Join over 50,000+ satisfied customers across Pakistan</p>
          </div>
        </div>
      </main>
